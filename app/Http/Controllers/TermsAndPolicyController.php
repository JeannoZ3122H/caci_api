...
class TermsAndPolicyController extends Controller
{
    ...
    public function index(){
        try {
            $terms_policys = TermsAndPolicyModel::all();
            if($terms_policys != null){return $terms_policys;}
            else{return $terms_policys = [];}
        } catch (\Throwable $e) {
    ...
    public function update(Request $request, $slg){
        try {
            if(isset($slg)){
                $data = TermsAndPolicyModel::Where('slug', '=', $slg)->first();
                if($data){
    ...
    public function delete($slg){
        try {
            ...
            $resp = TermsAndPolicyModel::where('slug', '=', $slg)->delete();
            if($resp){
                return response()->json(
                    [
                        'code' => 100,
