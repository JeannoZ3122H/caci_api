...
class TypesServicesController extends Controller
{
    ...
    public function index(){
        try {
            $list = TypesServicesModel::OrderBy('types_services_models.item_order', 'asc')
            ...
            ->groupBy('types_services_models.id', 'types_services_models.item_order')
            ->get();
    ...
    public function change_item_order(Request $request, $slg){
        try {
            ...
            $resp = TypesServicesModel::where('slug', '=', $slg)
