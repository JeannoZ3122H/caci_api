...
class SociauxController extends Controller
{
            ...
            if(empty($request->icon)):
                return response()->json(
                    [
                        'code' => 302,
                        'status' => 'Erreur',
                        'message' => MessageService::code302('icône')
                    ]
                );
            endif;
    ...
    public function update(Request $request, $slg){
        try {
            if(isset($slg)){
                ...
                $data = SociauxModel::Where('slug', '=', $slg)->first();
                if($data){
    ...
    public function delete($slg){
        try {
            ...
            $resp = SociauxModel::where('slug', '=', $slg)->delete();
            if($resp){
                return response()->json(
                    [
                        'code' => 100,
