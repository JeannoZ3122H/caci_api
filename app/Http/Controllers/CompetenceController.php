...

{
    ...
    public function index(){
        try {
            $type_events = CompetenceModel::all();
    ...
    public function store(Request $request){
        try {
            ...
            $add = new CompetenceModel();
            $add->competence = $request->competence;
    ...
    public function update(Request $request, $slg){
        try {
            if(isset($slg)){
                $data = CompetenceModel::Where('slug', '=', $slg)->first();
                if($data){
    ...
    public function delete($slg){
        try {
            ...
            $resp = CompetenceModel::where('slug', '=', $slg)->delete();
            if($resp){
                return response()->json(
                    [
                        'code' => 100,
